...
- Dᴇᴠᴇʟᴏᴘᴇʀ<a href=https://t.me/Praxxsh>A ᴅ ᴏ ʟ ғ 🔰 R ᴀ ᴍ</a>"""
  ...
  <b>🔰 𝙷𝙴𝚁𝙴 𝙸 𝚈𝙾𝚄 𝙲𝙰𝙽 𝙼𝙰𝙺𝙴 𝚈𝙾𝚄𝚁 𝙾𝚆𝙽 𝙱𝙾𝚃</b>

  <b>🔰 Iғ ʏᴏᴜ ᴅᴏɴ'ᴛ ʜᴀᴠᴇ ᴀ ᴏᴡɴ ᴀᴜᴛᴏ ғɪʟᴛᴇʀ ʙᴏᴛ ᴏʀ ᴅᴏɴ'ᴛ ʜᴀᴠᴇ ʜᴏsᴛɪɴɢ sᴇʀᴠᴇʀ ᴛᴏ ʜᴏsᴛ ʏᴏᴜʀ ʙᴏᴛ?</b> 

  <b>😥 Dᴏɴ'ᴛ Wᴏʀʀʏ!!! (ᴄʀᴇᴀᴛᴇ ᴀ ᴏᴡɴ ʙᴏᴛ ʟɪᴋᴇ ᴛʜɪs ʙᴏᴛ)</b>

  <b>💥Tʜᴇɴ ʏᴏᴜ ᴄᴀɴ ᴄʀᴇᴀᴛᴇ ᴏᴡɴ ʙᴏᴛ ᴜsɪɴɢ 🎭[/clone] ᴄᴏᴍᴍᴀɴᴅ ᴀɴᴅ ᴄᴜsᴛᴏᴍɪᴢᴇ ʏᴏᴜ ᴄʀᴇᴀᴛᴇᴅ ʙᴏᴛ ᴜsɪɴɢ sᴀᴍᴇ ᴄᴏᴍᴍᴀɴᴅ 🎭(/clone)</b>"""
  
    SHORT_LINK = """<b>NOTE:</b>
  <b>Yᴏᴜ ᴄᴀɴ sᴛᴀʀᴛ ᴇᴀʀɴɪɴɢ 💸 ᴍᴏɴᴇʏ ᴛᴏᴅᴀʏ ᴡɪᴛʜ ᴏᴜʀ Sɪᴍᴘʟᴇ ᴀɴᴅ ᴇᴀsʏ-ᴛᴏ-ᴜsᴇ ʙᴏᴛ!</b>

  <b>›› sᴛᴇᴘ 𝟷 : ʏᴏᴜ ᴍᴜsᴛ ʜᴀᴠᴇ ᴀᴛʟᴇᴀsᴛ ᴏɴᴇ ɢʀᴏᴜᴘ ᴡɪᴛʜ ᴍɪɴɪᴍᴜᴍ 𝟹𝟶𝟶 ᴍᴇᴍʙᴇʀs/nIғ ʏᴏᴜ ᴅᴏɴ'ᴛ Usɪɴɢ ᴀɴʏ sʜᴏʀᴛɴᴇʀ ᴡᴇʙsɪᴛᴇ ᴛʜᴇɴ ᴍᴀᴋᴇ ᴀᴄᴄᴏᴜɴᴛ ғɪʀsᴛ</b>

  <b>›› Sᴛᴇᴘ 𝟹: Cᴏᴘʏ ʏᴏᴜʀ API ғʀᴏᴍ ᴡᴇʙsɪᴛᴇ ᴀɴᴅ ᴛʜᴇɴ/nsɪᴍᴘʟʏ sᴇᴛ ʏᴏᴜʀ ᴡᴇʙsɪᴛᴇ ᴀɴᴅ API Usɪɴɢ ᴛʜᴇ /set_shortner ᴄᴏᴍᴍᴀɴᴅ</b>

  <b>›› Lɪᴋᴇ ᴛʜɪs</b> : <code>https://mdisklink.link/7C07c66d609ac5a5541cab6cc4a0e957d851a2e0af</code>

  <b> Tʜɪs ʙᴏᴛ ᴡɪʟʟ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴄᴏɴᴠᴇʀᴛs ʟɪɴᴋs ᴡɪᴛʜ Yᴏᴜʀ Aᴘɪ ᴀɴᴅ ᴡɪʟʟ ᴘʀᴏᴠɪᴅᴇ ʏᴏᴜʀ ʟɪɴᴋs.</b>

  <b> Dᴏɴ'ᴛ ᴡᴀɪᴛ ᴀɴʏ ʟᴏɴɢᴇʀ ᴛᴏ sᴛᴀʀᴛ ᴇᴀʀɴɪɴɢ ᴍᴏɴᴇʏ ғʀᴏᴍ ʏᴏᴜʀ ᴛᴇʟᴇɢʀᴀᴍ ɢʀᴏᴜᴘ. Aᴅᴅ ᴏᴜʀ ʙᴏᴛ ᴛᴏᴅᴀʏ ᴀɴᴅ sᴛᴀʀᴛ ᴍᴀᴋɪɴɢ ᴍᴏɴᴇʏ 💰!</b>"""
